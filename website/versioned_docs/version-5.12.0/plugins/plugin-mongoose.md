---
id: version-5.12.0-plugin-mongoose
title: graphql-compose-mongoose
sidebar_label: Mongoose plugin
original_id: plugin-mongoose
---
...
Source code: [https://github.com/graphql-compose/graphql-compose-mongoose-example](https://github.com/graphql-compose/graphql-compose-mongoose-example)
