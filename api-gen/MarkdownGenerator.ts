...
-->\n\n`;
  ...
  static parseSectionAndDocs(str: string = '', defaultSection: string = 'Methods') {
    ...
    return {
      section: section.replace(/^\s+|\s+$/g, '') || defaultSection,
      documentation: str.replace(/^\s+|\s+$/g, ''),
    };
  }
}
